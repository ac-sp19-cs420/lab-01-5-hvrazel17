...
//
    ...
    // pushing to the queue and printing it
    q_push(3, q);
    q_push(90,q);
    q_push(43,q);
    q_push(6,q);
    ...
    // testing the q_is_empty method (should return 0)
    printf("Testing q_is_empty method: \n");
    printf("%d\n", q_is_empty(q));
    
    // checking last method
    printf("This is the last integer in the queue: \n");
    printf("%d\n", last(q));
    
    // testing the pop method
    printf("The last int is now removed: \n");
    printf("%d\n", q_pop(q));
    q_print(q);
